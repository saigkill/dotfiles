...
#
# Script to bootstrap a Windows business box
#
# Authors:
...
# UnRar, Nuget Package Explorer, XAML Asset Explorer, WSA Tools, DevToys,
# Pichon Icons, Sysinternals Suite, XAML Studio,
# Raft WSL, GWSL, MSIX Packaging Tool, Pengwin, Prime Video, Amazon Appstore
# Windows Terminal
$WingetStoreApps = @(
"9PKGXJZ3XVBV",
"9WZDNCRDMDM3",
...
do {
    ...
    if ($response -eq 'y') {
        ...
        $pathToDotfilesInstaller = "..\install-business.ps1"
