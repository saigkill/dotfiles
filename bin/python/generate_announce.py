...
# This script just searches the opensuse-announce mailinglist for posts written max 7 days ago. Then it transforms it to the Wiki Layout for using in the openSUSE Weekly News.
...
URL = "http://lists.opensuse.org/opensuse-announce/mailinglist.rss"
...
# print date
 ...
 print "====["+str(url)+" "+str(str(subj).split("[opensuse-announce]")[1].strip())+"]===="
 #print "#####################"
 y = []
