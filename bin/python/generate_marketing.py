...
# This script just searches the opensuse-marketing mailinglist for posts written max 7 days ago. Then it transforms it to the Wiki Layout for using in the openSUSE Weekly News.
...
URL = "http://lists.opensuse.org/opensuse-marketing/mailinglist.rss"
...
for k in iterate:
 ...
 print "====["+str(url)+" "+str(str(subj).split("[opensuse-marketing]")[1].strip())+"]===="
 #print "#####################"
 y = []
