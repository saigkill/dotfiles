...
# This script just searches the opensuse-updates mailinglist for posts written max 7 days ago. Then it transforms it to the Wiki Layout for using in the openSUSE Weekly News.
...
URL = "http://lists.opensuse.org/opensuse-updates/mailinglist.rss"
